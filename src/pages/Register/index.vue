<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>登录密码:</label>
        <input type="password" placeholder="请输入你的登录密码" v-model="password" name="password" v-validate="{required:true,regex:/^[0-9A-Za-z]{6,16}$/}" :class="{invalid:errors.has('password')}">
      ...
      <div class="controls">
        <input type="checkbox" v-model="isAgree" name="isAgree" :class="{invalid:errors.has('isAgree')}" v-validate="{required:true,'agree':true}">
